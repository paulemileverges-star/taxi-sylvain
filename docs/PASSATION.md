...
APK Android : produits par EAS Build, profil `preview`. Derniers APK : **1.3.0 (versionCode 4), compilés le
20 septembre à 17 h** (commit `e542b5b`, avec les fichiers Firebase), rangés dans le dossier de passation OneDrive
