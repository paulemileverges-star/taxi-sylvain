...
APK Android : produits par EAS Build, profil `preview`. Derniers APK : **1.3.1 (versionCode 5), compilés le
23 septembre à 19 h** (commit `c1dd22a`, avec les fichiers Firebase ; compilations EAS `db648c54` chauffeur et `04303443` client), rangés dans le dossier de passation OneDrive
...
`https://api.taxisylvain.ca/uploads/apk/Taxi-Sylvain-Chauffeur-1.3.1.apk` et
`https://api.taxisylvain.ca/uploads/apk/Taxi-Sylvain-Client-1.3.1.apk` (type `application/vnd.android.package-archive`,
75 Mo chacun ; les fichiers 1.3.0 ont été retirés du volume le 23 septembre). Ce sont les liens à donner aux chauffeurs et aux clients ; les liens Expo
