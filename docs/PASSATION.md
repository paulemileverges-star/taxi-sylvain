...
1. **Suppression de compte** : **en ligne depuis le 19 septembre** pour les clients (app et page web `/suppression-compte`). Chauffeurs : par téléphone avec Taxi Sylvain, en attendant la décision du propriétaire sur la redevance (anonymiser le compte ou exiger le règlement). Les APK installés n'ont pas encore l'écran : il arrivera avec la prochaine compilation.
