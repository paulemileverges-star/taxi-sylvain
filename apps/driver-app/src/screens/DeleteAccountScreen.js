...
// Google Play et Apple exigent que le chauffeur puisse demander la suppression de son compte depuis
      ...
      <ScrollView style={{ flex: 1 }} contentContainerStyle={{ padding: 16 }}>
        ...
        <View style={styles.infoBox}>
          ...
          <Text style={styles.infoText}>
            ...
            D'ici là, votre compte reste utilisable : vous recevez et faites vos courses normalement.
          </Text>
        </View>
  ...
  return (
    <ScrollView style={{ flex: 1 }} contentContainerStyle={{ padding: 16 }}>
      ...
      <Text style={styles.item}>
        • À la validation, les courses qui vous sont confiées et qui ne sont pas terminées vous sont retirées :
      ...
      <Text style={styles.hint}>Taxi Sylvain peut refuser la demande, par exemple tant qu'un point reste à régler ; vous en recevez la raison par courriel.</Text>
      <TextInput
        style={styles.input}
